        ...
        if event.message['text']&.try!(:include?, "こんにちは") || event.message['text']&.try!(:include?, "やあ")|| event.message['text']&.try!(:include?, "やぁ")
          ...
          response = "その動画の視聴回数: #{viewcount} です \n その動画の高評価数: #{likecount}です \n その動画の低評価数: #{dislikecount} です \n その動画のチャンネル名: #{channelname} です \n  その動画のチャンネルのURL: https://www.youtube.com/channel/#{channelid}"
        	...
        	response = "チャットサイトですか？　ならKuroonRailsさんの作ったgoodchatがおすすめですよ！\n https://good-chat.herokuapp.com"
   			...
   			r = random.rand(1..3)
   			if r == 1
          message2 = "432432432432×43243243243242 は"
          keisan = 432432432432*43243243243242
   			elsif r == 2
          message2 = "989047290574845749373937494739 + 43432432432423432 + 43432523 × 5342432 は"
   			  keisan = 989047290574845749373937494739 + 43432432432423432 + 43432523 * 5342432
        elsif r == 3
   			  message2 = "439247932834792748923 ÷ 43242 ÷ 11 ÷ 342432 * 43242 は"
          keisan = 439247932834792748923 / 43242 / 11 / 342432 * 43242 
        end
          response = message1 + message2 + keisan.to_s
